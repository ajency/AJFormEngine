jQuery(document).ready(function($) {
  ...
  ajForm.addAutoSuggest = function(element) {
    ...
    _.each(divs, function(el, index) {
      ...
      return ajForm.autoSuggest[index] = {
        field: fieldName,
  ...
  ajForm.getAutosuggestJSON = function(data) {
    console.log(data);
    console.log(ajForm.autoSuggest);
    return _.each($('.ms-ctn'), function(el, index) {
      return console.log(ajForm.autoSuggest[index].field);
    });
  };
