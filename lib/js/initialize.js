jQuery(document).ready(function($) {
  ...
  $(this).on('aj:form:submit', function(event, data) {
    return console.log('aj:form:submit');
  });
  $(this).on('aj:form:ajax:before:submit', function(event, data) {
    return console.log('aj:form:ajax:before:submit');
  });
  $(this).on('aj:form:ajax:submit:complete', function(e, xhr) {
